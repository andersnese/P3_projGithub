...
public class SimulationGui extends JFrame implements Constants, ActionListener,
	 ...
	 * @param maxCpuTime
	 *            The maximum time quant used by the Round Robin algorithm.
	 * @param avgIoTime
	 *            The average duration of I/O operations.
	 ...
	 * 
	 * @param p
	 *            The panel to add the labels to.
	 * @param x
	 *            The x position of the leftmost label.
	 * @param y
	 ...
	 * @param leftText
	 *            The text to be displayed in the left label.
	 * @param rightText
	 *            The text to be displayed in the right label.
	 * @param text
	 ...
	 * 
	 * @param tk
	 *            The toolkit to be used to load the image.
	 * @param file
	 *            The name of the file containing the image.
	 * @param tracker
	 *            The media tracker tracking the progress of the load.
